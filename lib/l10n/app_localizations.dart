...
abstract class AppLocalizations {
  ...
  /// No description provided for @featureMentalHealthTitle.
  ///
  /// In en, this message translates to:
  /// **'Mental health insights'**
  String get featureMentalHealthTitle;

  /// No description provided for @featureMentalHealthDesc.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @featureConnectedTitle.
  ///
  /// In en, this message translates to:
  /// **'Stay connected'**
  String get featureConnectedTitle;

  /// No description provided for @featureConnectedDesc.
  ///
  /// In en, this message translates to:
  /// **'Reach out to friends, family, therapists and fellow veterans in one secure place.'**
  String get featureConnectedDesc;

  /// No description provided for @featureSharingTitle.
  ///
  /// In en, this message translates to:
  /// **'Permission-based sharing'**
  String get featureSharingTitle;

  /// No description provided for @featureSharingDesc.
  ///
  /// In en, this message translates to:
